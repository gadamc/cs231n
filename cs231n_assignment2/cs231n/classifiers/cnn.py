...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        #determine the volume of activations 
        #in the 'loss' function below, you'll see that the strides, pads and pool sizes are 
        #automatically set such that
        #H_conv = H, W_conv = W
        #H_pool = H/2, W_pool = W/2
        #So, W2.shape = (H * W * num_filters // 4,   hidden_dims)
